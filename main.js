...
const keyPlay = function(event) {
    ...
    event.target.style.backgroundColor = '#068CF7';
...
nextThree.onclick = function() {
    ...
    document.getElementById('letter-note-one') = 'F';
    document.getElementById('letter-note-one') = 'E';
    document.getElementById('letter-note-one') = 'C';
    document.getElementById('letter-note-one') = 'D';
    document.getElementById('letter-note-one') = 'C';
